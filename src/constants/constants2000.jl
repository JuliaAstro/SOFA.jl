...
const l_1994 = [450160.28, -482890.539, 7.455, 0.008]

#   Initial obliquity of the ecliptic in arcseconds
const ϵ0_2000 = 84381.448

#   Earth rotation angle
const era_2000 = (0.779057273264, 0.00273781191135448)
...
const r_gal_icrs = SMatrix{3, 3}(
    -0.054875560416215368492398900454, +0.494109427875583673525222371358, -0.86766614901900470118161653457,
...
const efac = (1.0, -0.002516, -0.0000074)
...
const lr_1998 = [
    ...
    PeriodicTerms([4, -1, 0, 0], [0.00052, -1571.0]),
    ...
    PeriodicTerms([3, 0, -2, 0], [-0.00034, 0.0]),
    PeriodicTerms([4, 0, -3, 0], [0.00033, 0.0]),
    ...
    PeriodicTerms([2, 0, -1, -2], [0.0, 8752.0]),
]
...
const b_1998 = [
    ...
    PeriodicTerms([1, 1, 0, 1], [0.000223]),
    PeriodicTerms([0, 1, -2, -1], [-0.00022]),
    PeriodicTerms([2, 1, -1, -1], [-0.00022]),
